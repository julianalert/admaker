...
function buildPageHref(page: number): string {
  if (page <= 1) return '/dashboard/gallery'
  return `/dashboard/gallery?page=${page}`
}

export default function GalleryPagination({ currentPage, totalPages }: GalleryPaginationProps) {
  ...
  return (
    <div className="flex justify-center">
      <nav className="flex items-center gap-1" role="navigation" aria-label="Gallery pagination">
        <div>
          {hasPrev ? (
            <Link
              href={prevHref}
