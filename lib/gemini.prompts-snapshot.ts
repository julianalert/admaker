/**
 * Saved copy of image-generation prompts and per-slot logic (no creative director).
 * Use this module when you want the OLD flow: 3/5/7/9 photos, per-slot suggest* calls.
 * See docs/PHOTOSHOOT-STATUS.md for current status.
 */
