        ...
        <div className="space-y-8 flex-1 min-h-0">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Ads (Coming soon) - not clickable */}
              <li className="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 opacity-75">
                <span className="flex items-center justify-between cursor-default pointer-events-none text-gray-500 dark:text-gray-400">
                  <div className="flex items-center min-w-0">
                    <svg className="shrink-0 text-gray-400 dark:text-gray-500 w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="shrink-0 ml-2 text-xs inline-flex font-medium bg-violet-500/20 text-violet-600 dark:text-violet-400 rounded-full text-center px-2.5 py-1 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                    Coming soon
                  </span>
                </span>
              </li>
